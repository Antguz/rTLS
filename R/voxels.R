...
#' @param voxel.size A positive \code{numeric} vector with the voxel edge length for the x, y, and z coordinate. It use the same dimensional scale of the point cloud.
...
#' voxels(pc_tree, voxel.size = c(0.5, 0.5, 0.5))
#'
#' ###Returns just the coordinates of the voxels and the number of points in each cube
#' voxels(pc_tree, voxel.size = c(0.5, 0.5, 0.5), obj.voxel = FALSE)
#'
#' @export
